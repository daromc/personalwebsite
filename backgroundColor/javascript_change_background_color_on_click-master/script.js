...
// Method 1: Basic Method
 ...
 function btnChanger1() {
    let bg = document.getElementById("container").style.background = "blue";
    let x = document.getElementById("btn-color").style.background = "indigo";
    let y = document.getElementById("btn-color").style.color = "gold";
 ...
 function btnChanger3() {
    let bg = document.getElementById("container").style.background = "yellow";
    let x = document.getElementById("btn-color").style.background = "indigo";
    let y = document.getElementById("btn-color").style.color = "gold";
    
 }
function btnChanger_reset(){
    let bg = document.getElementById("container").style.background = "linear-gradient(45deg, #6ea7fd, #69018f)";
    let x = document.getElementById("btn-color").style.background = "#0471d6";
    let y = document.getElementById("btn-color").style.color = "white";
}
